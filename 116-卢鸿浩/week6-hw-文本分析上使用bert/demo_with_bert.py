...
class TorchModel(nn.Module):
    def __init__(self, input_dim, sentence_length, vocab):
        ...
        self.bert = BertModel.from_pretrained(r"E:\works\codes\python\bert-bass-chinese\bert-base-chinese", return_dict=False)
...
if __name__ == "__main__":
    main()
    test_strings = ["juvaee", "yrabcg", "rtweqg", "nlhdww","abcese","exyzpo","ovuxyz","rtwwoc", "nvewww"]
