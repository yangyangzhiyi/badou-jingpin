...
class KMeansClusterer:  # k均值聚类
    ...
    def cluster(self):
        ...
        if (self.points == new_center).all():
            sum, avg_distance = self.__sumdis(result)
            return result, self.points, sum, avg_distance
...
result, centers, sum_distance, avg_distance = kmeans.cluster()
print(result)
print(centers)
print(sum_distance)
print(avg_distance)
