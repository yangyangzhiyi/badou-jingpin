...
"""
tokenizer = BertTokenizer.from_pretrained(r"G:/badouai/https：／／github.com／infchaos／badou-jingpin/badou-jingpin/107-冯佐尉/week6/bert-base-chinese")
...
class TorchModel(nn.Module):
    def __init__(self, input_dim):
        ...
        self.bert = BertModel.from_pretrained(
            r"G:/badouai/https：／／github.com／infchaos／badou-jingpin/badou-jingpin/107-冯佐尉/week6/bert-base-chinese",
            return_dict=False)
...
def main():
    ...
    for epoch in range(epoch_num):
        ...
        print("=========/n第%d轮平均loss:%f" % (epoch + 1, np.mean(watch_loss)))
    # 保存模型
