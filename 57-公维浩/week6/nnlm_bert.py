...
class LanguageModel(nn.Module):
    def __init__(self, input_dim, vocab):
        ...
        self.bert = BertModel.from_pretrained(r"E:\Code\model\bert-base-chinese", return_dict=False)
    ...
    def forward(self, x, y=None):
        ...
        # x = self.dropout(x)
        _, pooler_output = self.bert(x)  # sequence_output(batch_size, sen_len, hidden_size)
        x = self.classify(pooler_output)  # pooler_output(batch_size, hidden_size)
