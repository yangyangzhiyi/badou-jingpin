...
def evaluate(model, vocab, sample_length):
    ...
    with torch.no_grad():
        ...
        wrong += len(y) - correct
        # for y_p, y_t in zip(y_pred, dim=-1):  #与真实标签进行对比
...
def main():
    ...
    plt.show()
    #保存模型
    torch.save(model.state_dict(), "/Users/kevin/Downloads/week2 深度学习常用组件-1/model.pth")
    # 保存词表
    writer = open("/Users/kevin/Downloads/week2 深度学习常用组件-1/vocab.json", "w", encoding="utf8")
...
def predict(model_path, vocab_path, input_strings):
    ...
    sentence_length = 6  # 样本文本长度
    import os;
    print(os.path.abspath(vocab_path))
...
if __name__ == "__main__":
    main()
    test_strings = ["ffvaee", "cwsdfg", "rqwdyg", "nlkwww", "你我他你我他"]
    predict("/Users/kevin/Downloads/week2 深度学习常用组件-1/model.pth", "/Users/kevin/Downloads/week2 深度学习常用组件-1/vocab.json", test_strings)
